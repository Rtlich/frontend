        ...
        <form action="https://formcarry.com/s/S1peCWurw0C" method="POST" name="contact-form" id="contact-form" onsubmit="return validateForm();">
          <div class="form-row two2">
            <div class="form-group col-md-6 column">
              <input type="text" class="form-control input" id="movieName" name="movienamee" placeholder=" " >
              <label for="movienamee" class="">Movie Name</label>
              <div class="underline">
              </div>
             
            </div>
            <script type="text/javascript">
              // Retrieve movie name from query parameters
              var params = new URLSearchParams(window.location.search);
              var moviename = params.get("movie");
              

          
              // Display movie name on the page
              var movienameElement = document.getElementById("movieName");
              movienameElement.value = moviename;
...
$sql = "SELECT idroom FROM movies WHERE moviename = :moviename";
...
?>
            ...
            <div class="form-group col-md-6 column">
              <input type="text" class="form-control input" id="roomId" name="idRoom" placeholder=" " value="<?php echo $roomId; ?>" >
              <label for="idRoom" class="">ID Room</label>
...
<div class="form-row two2">
  <div class="form-group col-md-6 column">
    <input type="number" class="form-control input" name="Contact" id="Contact"  placeholder=" ">
  ...
  <div class="form-group col-md-6 column">
    <input type="number" class="form-control input" name="nbr_ticket" id="nbr_ticket"  placeholder=" ">
    <label for="nbr_ticket" class="">Number of Tickets</label>
    <div class="underline">
    </div>
  </div>
</div>
...
<div class="form-row two2">
  <div class="form-group col-md-6 column">
    <input type="text" class="form-control input" name="mail" id="mail"  placeholder=" ">
  ...
  <div class="form-group col-md-6 column">
    ...
    <input type="datetime-local" class="form-control input" id="datee" name="datee" placeholder=" ">
    <label for="datee" class="">Reservation Date</label>
    <div class="underline"></div>
  </div>
</div>
      ...
      <footer class="footer">
        <div class="footer-content">
          <div class="footer-left">
            <a href="home.html"><img class="footer-logo" src="C:\xampp\htdocs\ticketeasy  v1\Images\Logo\TheaterLogo.png" alt="" width="30"
                height="24"></a>
